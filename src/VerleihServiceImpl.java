        ...
        implements VerleihService
{
	...
	{
    	// Wir sollten den Kunden kennen, an den wir verleihen wollen.
    	assert(kundeImBestand(kunde)) : "Vorbedingung verletzt: kundeImBestand(kunde)";
    	// Es wäre blöd, wenn die zu verliehenden Medien schon verliehen sind.
    	assert(sindAlleNichtVerliehen(medien)) : "Vorbedingung verletzt: sindAlleNichtVerliehen(medien)";
    	// ausleihDatum != null ist Vorbedingung im Verleihkarten-Konstruktor.
    	// Als Klient dieser Klasse müssen wir dies also garantieren.
